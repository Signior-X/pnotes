...
"resource": {
  ...
  "rules":[
    ...
    [["if",1,17],["add",18]],
    [["if",1,2],["unless",6],["add",19,21,25,44]],
    [["if",1],["unless",2,6],["add",20,26,29,32,36,37,38]],
    [["if",1],["unless",2,6,9],["add",22]],
    [["if",1,19],["add",27]],
    [["if",1,20],["add",33]],
    [["if",1,2,21],["add",34]],
    [["if",22],["add",39]],
    [["if",1],["unless",2,23,24,25,26],["add",41]]]
},
"runtime":[]
...
return null},Fd=!1;if(H.querySelectorAll)try{var Gd=H.querySelectorAll(":root");Gd&&1==Gd.length&&Gd[0]==H.documentElement&&(Fd=!0)}catch(a){}var Cd=Fd;var Ud={},L=null,Vd=Math.random();Ud.B="GTM-5W9QXH7";Ud.Yb="9u1";Ud.Xh="";var Wd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Xd={__paused:!0,__tg:!0},Yd;for(Yd in Wd)Wd.hasOwnProperty(Yd)&&(Xd[Yd]=!0);var Zd="www.googletagmanager.com/gtm.js";
var $d=Zd,ae=Ha(""),be=null,ce=null,de="//www.googletagmanager.com/a?id="+Ud.B+"&cv=182",ee={},fe={},ge=function(){var a=L.sequence||1;L.sequence=a+1;return a};
...
var Fe={},Ge=new Da,He={},Ie={},Le={name:"GTMDataLayer",set:function(a,b){m(Sa(a,b),He);Je()},get:function(a){return Ke(a,2)},reset:function(){Ge=new Da;He={};Je()}},Ke=function(a,b){if(2!=b){var c=Ge.get(a);Ae&&c!==Me(a.split("."))&&D(5);return c}return Me(a.split("."))},Me=function(a){for(var b=He,c=0;c<a.length;c++){if(null===b)return!1;if(void 0===b)break;b=b[a[c]]}return b},Ne=function(a,b){Ie.hasOwnProperty(a)||(Ge.set(a,b),m(Sa(a,b),He),Je())},Je=function(a){Fa(Ie,function(b,c){Ge.set(b,c);
...
return!a}function ul(){var a=tl();try{Uk(F["GTMDataLayer"],Ud.B)}catch(b){}return a}
var wl=function(){var a=Tc("GTMDataLayer",[]),b=Tc("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};wh(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});Jk(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<L.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new nl(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);ol.push.apply(ol,e);if(300<
...
(void 0===F[a]||c&&!F[a])&&(F[a]=b);return F[a]},gm=function(a,b,c){return ef(a,b,void 0===c?!0:!!c)},hm=function(a,b,c){return 0===of(a,b,c)},im=function(a,b){if(Og()){b&&J(b)}else Xc(a,b)},jm=function(a){return!!El(a,"init",!1)},km=function(a){Cl(a,"init",!0)},lm=function(a,b){var c=(void 0===b?0:b)?"www.googletagmanager.com/gtag/js":$d;c+="?id="+encodeURIComponent(a)+"&l=GTMDataLayer";O(Qg("https://","http://",c))},mm=function(a,
